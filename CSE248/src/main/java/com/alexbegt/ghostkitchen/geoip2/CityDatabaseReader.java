package com.alexbegt.ghostkitchen.geoip2;
 ...
 * </p>
 */
public class CityDatabaseReader implements DatabaseProvider, Closeable {
  ...
  private CityDatabaseReader(Builder builder) throws IOException {
  ...
  public static final class Builder {
     ...
     */
    public CityDatabaseReader build() throws IOException {
      return new CityDatabaseReader(this);
    }
  }
